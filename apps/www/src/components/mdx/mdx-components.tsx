...
const components: any = {
    ...
    h2: ({ className, ...props }: ElementProps) => (
        <h2
            className={cn(
    ...
    a: ({ className, ...props }: ElementProps) => (
        <a
            className={cn(
    ...
    ul: ({ className, ...props }: ElementProps) => (
        <ul className={cn("my-6 ml-6 list-disc", className)} {...props} />
    ),
    ol: ({ className, ...props }: ElementProps) => (
    ...
    th: ({ className, ...props }: ElementProps) => (
        <th
            className={cn(
    ...
    td: ({ className, ...props }: ElementProps) => (
        <td
            className={cn(
    ...
    pre: ({ className, ...props }: ElementProps) => (
        <pre
            className={cn(
