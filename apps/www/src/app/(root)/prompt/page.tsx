            ...
            <main className="relative px-[4rem]  py-[3rem] flex justify-center items-center gap-[3rem] h-full w-full">
                <div className="absolute bottom-[2rem] flex flex-col justify-center items-center gap-[1rem]">
                    <div className="mb-[2rem] flex flex-col gap-[1rem] ">
                        <h4 className="cursor-pointer px-[1.6rem] py-[.8rem] w-[35rem] rounded-[.4rem] text-light_text_gray/50 dark:text-dark_text_gray/20 bg-light_bg_50  dark:bg-dark_bg_50 ">
                    ...
                    <div className="px-[2rem] w-[40rem] flex items-center flex-row rounded-[.4rem] bg-light_bg_50 dark:bg-dark_bg_50 ">
                        <input
                            type="text"
