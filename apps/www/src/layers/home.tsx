    ...
    return (
        <>
            <main className="flex h-full w-full flex-1 flex-col items-center justify-center">
                <div
                    id="intro"
                    className="flex flex-col items-center justify-center gap-y-8 md:gap-y-10"
                >
                    ...
                    <div className="mt-8 flex w-full flex-col items-center justify-center gap-y-4 md:flex-row">
                        <Button
                            variant={"default"}
